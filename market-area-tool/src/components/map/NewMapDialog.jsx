...
const API_KEY = "-A-B4EsyQJQ2659AVgnbyISk4-3bqAcXSGdxd48agv5GOufGX382QIckdN21BhJdzEP3v3Xt1nKug1Y.AT1_ioxXSAbW";
...
export default function MapComponent({ onToggleList }) {
  ...
  const [tabs, setTabs] = useState([
    ...
    { id: 2, name: 'Map 2', active: false },
    { id: 3, name: 'Map 3', active: false }
  ]);
