...
}, [formState.maType, removeActiveLayer, clearSelection, selectionGraphicsLayer]);
  ...
  const handleCancel = useCallback(async () => {
    try {
      ...
      if (editingMarketArea) {
        ...
        // Redraw the original market area
        if (editingMarketArea.locations?.length > 0) {
